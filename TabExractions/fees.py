...
### 🛠️ **Parameters**:
- **url** *(str)*: The URL of the webpage containing the fees information from which the data is to be extracted 🌍.
- **chrome_driver_path** *(str, optional)*: The file path to the Chrome WebDriver executable. It is used to start the automated browser session for web scraping 🖥️.
